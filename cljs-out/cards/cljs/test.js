...
var G__23679 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__23679,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23679;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23681){
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__23688,map__23688__$1,file,line,column){
return (function (p1__23687_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23687_SHARP_));
});})(map__23688,map__23688__$1,file,line,column))
...
var temp__5735__auto___23690 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___23690)){
var message_23691 = temp__5735__auto___23690;
cljs.core.println.call(null,message_23691);
} else {
}
...
var temp__5735__auto___23692 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___23692)){
var message_23693 = temp__5735__auto___23692;
cljs.core.println.call(null,message_23693);
} else {
}
...
var output_dir__$1 = (function (){var G__23694 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__23694,"/"].join('');
} else {
return G__23694;
}
})();
...
var G__23696 = exception.stack;
var G__23696__$1 = (((G__23696 == null))?null:clojure.string.split_lines.call(null,G__23696));
var G__23696__$2 = (((G__23696__$1 == null))?null:cljs.core.get.call(null,G__23696__$1,depth));
if((G__23696__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23696__$2);
}
} else {
...
var vec__23697 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23697,(0),null);
var column = cljs.core.nth.call(null,vec__23697,(1),null);
var vec__23700 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23700,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23700,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23700,(2),null);
...
var m__$1 = (function (){var G__23703 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__23707 = (function (){var G__23706 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23706);
} else {
return G__23706;
}
})();
...
return cljs.core.vary_meta.call(null,G__23708,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__23712 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23712,(0),null);
var types = vec__23712;
...
var vars__$1 = cljs.core.nth.call(null,vec__23716,(1),null);
return ((function (vec__23716,ns,vars__$1){
return (function (){
...
var G__23719 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1){
return (function (){
var seq__23720 = cljs.core.seq.call(null,vars__$1);
var chunk__23721 = null;
var count__23722 = (0);
var i__23723 = (0);
while(true){
if((i__23723 < count__23722)){
var v = cljs.core._nth.call(null,chunk__23721,i__23723);
var temp__5735__auto___23725 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___23725)){
var t_23726 = temp__5735__auto___23725;
each_fixture_fn.call(null,((function (seq__23720,chunk__23721,count__23722,i__23723,t_23726,temp__5735__auto___23725,v,each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23726)));
});})(seq__23720,chunk__23721,count__23722,i__23723,t_23726,temp__5735__auto___23725,v,each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1))
);
} else {
}


var G__23727 = seq__23720;
var G__23728 = chunk__23721;
var G__23729 = count__23722;
var G__23730 = (i__23723 + (1));
seq__23720 = G__23727;
chunk__23721 = G__23728;
count__23722 = G__23729;
i__23723 = G__23730;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__23720);
if(temp__5735__auto__){
var seq__23720__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23720__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__23720__$1);
var G__23731 = cljs.core.chunk_rest.call(null,seq__23720__$1);
var G__23732 = c__4550__auto__;
var G__23733 = cljs.core.count.call(null,c__4550__auto__);
var G__23734 = (0);
seq__23720 = G__23731;
chunk__23721 = G__23732;
count__23722 = G__23733;
i__23723 = G__23734;
continue;
} else {
var v = cljs.core.first.call(null,seq__23720__$1);
var temp__5735__auto___23735__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___23735__$1)){
var t_23736 = temp__5735__auto___23735__$1;
each_fixture_fn.call(null,((function (seq__23720,chunk__23721,count__23722,i__23723,t_23736,temp__5735__auto___23735__$1,v,seq__23720__$1,temp__5735__auto__,each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23736)));
});})(seq__23720,chunk__23721,count__23722,i__23723,t_23736,temp__5735__auto___23735__$1,v,seq__23720__$1,temp__5735__auto__,each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1))
);
} else {
}


var G__23737 = cljs.core.next.call(null,seq__23720__$1);
var G__23738 = null;
var G__23739 = (0);
var G__23740 = (0);
seq__23720 = G__23737;
chunk__23721 = G__23738;
count__23722 = G__23739;
i__23723 = G__23740;
continue;
}
} else {
...
});})(each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1))
);
});})(each_fixture_fn,G__23719,G__23719__$1,env,once_fixtures,each_fixtures,vec__23716,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23719__$1)].join('')));

}
})());
});
;})(vec__23716,ns,vars__$1))
