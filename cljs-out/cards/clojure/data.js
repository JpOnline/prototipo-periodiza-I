...
return cljs.core.reduce.call(null,(function (result,p__29069){
...
var vec__29073 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__29073,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__29073,(1),null);
var ab = cljs.core.nth.call(null,vec__29073,(2),null);
...
return (function (){var G__29082 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29082__$1)].join('')));
