...
return cljs.core.reduce.call(null,(function (result,p__25234){
...
var vec__25238 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__25238,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__25238,(1),null);
var ab = cljs.core.nth.call(null,vec__25238,(2),null);
...
return (function (){var G__25247 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25247__$1)].join('')));
