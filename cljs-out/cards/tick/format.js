...
return tick.format.formatter.call(null,fmt,(function (){try{var G__13721 = goog.object.get(JSJodaLocale,"Locale");
if((G__13721 == null)){
return null;
} else {
return goog.object.get(G__13721,"US");
}
}catch (e13720){if((e13720 instanceof Error)){
var e = e13720;
return null;
} else {
throw e13720;
