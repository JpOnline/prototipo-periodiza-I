...
return tick.format.formatter.call(null,fmt,(function (){try{var G__13700 = goog.object.get(JSJodaLocale,"Locale");
if((G__13700 == null)){
return null;
} else {
return goog.object.get(G__13700,"US");
}
}catch (e13699){if((e13699 instanceof Error)){
var e = e13699;
return null;
} else {
throw e13699;
