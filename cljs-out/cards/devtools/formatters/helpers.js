...
var G__27794 = devtools.prefs.pref.call(null,v);
v = G__27794;
continue;
} else {
return v;
...
}catch (e27797){var _e__26806__auto__ = e27797;
return false;
}})();
...
}catch (e27801){var _e__26806__auto__ = e27801;
return false;
}})();
...
}catch (e27803){var _e__26806__auto__ = e27803;
return false;
}}
}
});
...
var vec__27805 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27805,(0),null);
var name = cljs.core.nth.call(null,vec__27805,(1),null);
...
return cljs.core.some.call(null,(function (p1__27808_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27808_SHARP_);
}),template);
});
