...
var G__27799 = devtools.prefs.pref.call(null,v);
v = G__27799;
continue;
} else {
return v;
...
}catch (e27802){var _e__26811__auto__ = e27802;
return false;
}})();
...
}catch (e27806){var _e__26811__auto__ = e27806;
return false;
}})();
...
}catch (e27808){var _e__26811__auto__ = e27808;
return false;
}}
}
});
...
var vec__27810 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27810,(0),null);
var name = cljs.core.nth.call(null,vec__27810,(1),null);
...
return cljs.core.some.call(null,(function (p1__27813_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27813_SHARP_);
}),template);
});
