...
var o27665 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27665["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27666 = temp__5733__auto____$1;
return (o27666["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26775__auto__ = f;
return (o__26775__auto__["toString"]).call(o__26775__auto__);
} else {
return "";
}
}catch (e27667){var _ = e27667;
return "";
}});
...
try{var o__26775__auto___27669 = t;
(o__26775__auto___27669["cljs$lang$ctorPrWriter"]).call(o__26775__auto___27669,t,writer);
}catch (e27668){var __27670 = e27668;
}
...
var char_code = (function (){var o__26775__auto__ = (new String(char$));
return (o__26775__auto__["charCodeAt"]).call(o__26775__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26775__auto__ = String;
return (o__26775__auto__["fromCharCode"]).call(o__26775__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27671 = num_code;
switch (G__27671) {
case (1):
return (185);
...
var o__26775__auto__ = String;
return (o__26775__auto__["fromCharCode"]).call(o__26775__auto__,superscript_code);
});
/**
...
}catch (e27673){var _e__26782__auto__ = e27673;
return false;
}})())){
...
var vec__27674 = devtools.munging.parse_fn_source.call(null,fn_source);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27677 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27677["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27678 = temp__5733__auto____$1;
return (o27678["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27681){
var vec__27682 = p__27681;
var ns_detector = cljs.core.nth.call(null,vec__27682,(0),null);
...
var G__27688 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27689 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27688;
remaining_tokens = G__27689;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27679){
var G__27680 = cljs.core.first.call(null,seq27679);
var seq27679__$1 = cljs.core.next.call(null,seq27679);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27680,seq27679__$1);
});
...
var vec__27693 = cljs.core.split_with.call(null,(function (p1__27692_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27692_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27693,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27693,(1),null);
...
var vec__27699 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27699,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27699,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27702 = cljs.core.rest.call(null,remaining_tokens);
var G__27703 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27702;
name_tokens = G__27703;
continue;
} else {
...
var vec__27706 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27706,(0),null);
var arity = cljs.core.nth.call(null,vec__27706,(1),null);
var vec__27709 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27709,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27709,(1),null);
var vec__27712 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27712,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27712,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27712,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27712,(3),null);
...
var vec__27718 = result;
var munged_ns = cljs.core.nth.call(null,vec__27718,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27718,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27718,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27718,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27718,(4),null);
var arity = cljs.core.nth.call(null,vec__27718,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27722 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__27722,(0),null);
var args = cljs.core.nth.call(null,vec__27722,(1),null);
var vec__27725 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27725,(0),null);
var name = cljs.core.nth.call(null,vec__27725,(1),null);
...
var G__27728 = (arity + (1));
var G__27729 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27730){
var vec__27731 = p__27730;
var arity = cljs.core.nth.call(null,vec__27731,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27731,(1),null);
...
return cljs.core.get.call(null,arities,p1__27734_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27735_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27738){
var vec__27739 = p__27738;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27739,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27736){
var G__27737 = cljs.core.first.call(null,seq27736);
var seq27736__$1 = cljs.core.next.call(null,seq27736);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27737,seq27736__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27747__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27747__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27747__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27747__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27748 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27748,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27748,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27748,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27748,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27748,(4),null);
var arity = cljs.core.nth.call(null,vec__27748,(5),null);
...
var o__26775__auto__ = f;
return (o__26775__auto__["getBasis"]).call(o__26775__auto__);
});
/**
...
}catch (e27752){var _e__26782__auto__ = e27752;
...
var G__27753 = (obj[cljs.core.first.call(null,path)]);
var G__27754 = cljs.core.rest.call(null,path);
obj = G__27753;
path = G__27754;
continue;
} else {
...
return (function (accum,p__27755){
var vec__27756 = p__27755;
var bit = cljs.core.nth.call(null,vec__27756,(0),null);
var protocol = cljs.core.nth.call(null,vec__27756,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27759){
var vec__27760 = p__27759;
var ns = cljs.core.nth.call(null,vec__27760,(0),null);
var name = cljs.core.nth.call(null,vec__27760,(1),null);
var selector = cljs.core.nth.call(null,vec__27760,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27765,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27765,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27765,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27763_SHARP_){
return (obj[cljs.core.first.call(null,p1__27763_SHARP_)]);
});})(name,sorted_matches,vec__27765,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
