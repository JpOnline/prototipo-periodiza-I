...
var temp__5733__auto____$1 = (o27694["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27695 = temp__5733__auto____$1;
return (o27695["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26804__auto__ = f;
return (o__26804__auto__["toString"]).call(o__26804__auto__);
} else {
return "";
}
}catch (e27696){var _ = e27696;
return "";
}});
...
try{var o__26804__auto___27698 = t;
(o__26804__auto___27698["cljs$lang$ctorPrWriter"]).call(o__26804__auto___27698,t,writer);
}catch (e27697){var __27699 = e27697;
}
...
var char_code = (function (){var o__26804__auto__ = (new String(char$));
return (o__26804__auto__["charCodeAt"]).call(o__26804__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26804__auto__ = String;
return (o__26804__auto__["fromCharCode"]).call(o__26804__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27700 = num_code;
switch (G__27700) {
case (1):
return (185);
...
var o__26804__auto__ = String;
return (o__26804__auto__["fromCharCode"]).call(o__26804__auto__,superscript_code);
});
/**
...
}catch (e27702){var _e__26811__auto__ = e27702;
return false;
}})())){
...
var vec__27703 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27703,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27706 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27706["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27707 = temp__5733__auto____$1;
return (o27707["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27710){
var vec__27711 = p__27710;
var ns_detector = cljs.core.nth.call(null,vec__27711,(0),null);
...
var G__27717 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27718 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27717;
remaining_tokens = G__27718;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27708){
var G__27709 = cljs.core.first.call(null,seq27708);
var seq27708__$1 = cljs.core.next.call(null,seq27708);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27709,seq27708__$1);
});
...
var vec__27722 = cljs.core.split_with.call(null,(function (p1__27721_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27721_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27722,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27722,(1),null);
...
var vec__27728 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27728,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27728,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27731 = cljs.core.rest.call(null,remaining_tokens);
var G__27732 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27731;
name_tokens = G__27732;
continue;
} else {
...
var vec__27735 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27735,(0),null);
var arity = cljs.core.nth.call(null,vec__27735,(1),null);
var vec__27738 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27738,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27738,(1),null);
var vec__27741 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27741,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27741,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27741,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27741,(3),null);
...
var vec__27747 = result;
var munged_ns = cljs.core.nth.call(null,vec__27747,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27747,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27747,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27747,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27747,(4),null);
var arity = cljs.core.nth.call(null,vec__27747,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27751 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__27751,(0),null);
var args = cljs.core.nth.call(null,vec__27751,(1),null);
var vec__27754 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27754,(0),null);
var name = cljs.core.nth.call(null,vec__27754,(1),null);
...
var G__27757 = (arity + (1));
var G__27758 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27759){
var vec__27760 = p__27759;
var arity = cljs.core.nth.call(null,vec__27760,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27760,(1),null);
...
return cljs.core.get.call(null,arities,p1__27763_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27764_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27767){
var vec__27768 = p__27767;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27768,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27765){
var G__27766 = cljs.core.first.call(null,seq27765);
var seq27765__$1 = cljs.core.next.call(null,seq27765);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27766,seq27765__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27776__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27776__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27776__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27776__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27777 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27777,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27777,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27777,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27777,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27777,(4),null);
var arity = cljs.core.nth.call(null,vec__27777,(5),null);
...
var o__26804__auto__ = f;
return (o__26804__auto__["getBasis"]).call(o__26804__auto__);
});
/**
...
}catch (e27781){var _e__26811__auto__ = e27781;
...
var G__27782 = (obj[cljs.core.first.call(null,path)]);
var G__27783 = cljs.core.rest.call(null,path);
obj = G__27782;
path = G__27783;
continue;
} else {
...
return (function (accum,p__27784){
var vec__27785 = p__27784;
var bit = cljs.core.nth.call(null,vec__27785,(0),null);
var protocol = cljs.core.nth.call(null,vec__27785,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27788){
var vec__27789 = p__27788;
var ns = cljs.core.nth.call(null,vec__27789,(0),null);
var name = cljs.core.nth.call(null,vec__27789,(1),null);
var selector = cljs.core.nth.call(null,vec__27789,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27794,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27794,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27794,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27792_SHARP_){
return (obj[cljs.core.first.call(null,p1__27792_SHARP_)]);
});})(name,sorted_matches,vec__27794,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
