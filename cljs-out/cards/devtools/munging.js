...
var o27689 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27689["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27690 = temp__5733__auto____$1;
return (o27690["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26799__auto__ = f;
return (o__26799__auto__["toString"]).call(o__26799__auto__);
} else {
return "";
}
}catch (e27691){var _ = e27691;
return "";
}});
...
try{var o__26799__auto___27693 = t;
(o__26799__auto___27693["cljs$lang$ctorPrWriter"]).call(o__26799__auto___27693,t,writer);
}catch (e27692){var __27694 = e27692;
}
...
var char_code = (function (){var o__26799__auto__ = (new String(char$));
return (o__26799__auto__["charCodeAt"]).call(o__26799__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26799__auto__ = String;
return (o__26799__auto__["fromCharCode"]).call(o__26799__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27695 = num_code;
switch (G__27695) {
case (1):
return (185);
...
var o__26799__auto__ = String;
return (o__26799__auto__["fromCharCode"]).call(o__26799__auto__,superscript_code);
});
/**
...
}catch (e27697){var _e__26806__auto__ = e27697;
return false;
}})())){
...
var vec__27698 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27698,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27701 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27701["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27702 = temp__5733__auto____$1;
return (o27702["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27705){
var vec__27706 = p__27705;
var ns_detector = cljs.core.nth.call(null,vec__27706,(0),null);
...
var G__27712 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27713 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27712;
remaining_tokens = G__27713;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27703){
...
var vec__27717 = cljs.core.split_with.call(null,(function (p1__27716_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27716_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27717,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27717,(1),null);
...
var vec__27723 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27723,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27723,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27726 = cljs.core.rest.call(null,remaining_tokens);
var G__27727 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27726;
name_tokens = G__27727;
continue;
} else {
...
var vec__27730 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27730,(0),null);
var arity = cljs.core.nth.call(null,vec__27730,(1),null);
var vec__27733 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27733,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27733,(1),null);
var vec__27736 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27736,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27736,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27736,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27736,(3),null);
...
var vec__27742 = result;
var munged_ns = cljs.core.nth.call(null,vec__27742,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27742,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27742,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27742,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27742,(4),null);
var arity = cljs.core.nth.call(null,vec__27742,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27746 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__27746,(0),null);
var args = cljs.core.nth.call(null,vec__27746,(1),null);
var vec__27749 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__27752 = (arity + (1));
var G__27753 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27754){
var vec__27755 = p__27754;
var arity = cljs.core.nth.call(null,vec__27755,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27755,(1),null);
...
return cljs.core.get.call(null,arities,p1__27758_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27759_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27762){
var vec__27763 = p__27762;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27763,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27760){
var G__27761 = cljs.core.first.call(null,seq27760);
var seq27760__$1 = cljs.core.next.call(null,seq27760);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27761,seq27760__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27771__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27771__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27771__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27771__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27772 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27772,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27772,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27772,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27772,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27772,(4),null);
var arity = cljs.core.nth.call(null,vec__27772,(5),null);
...
var o__26799__auto__ = f;
return (o__26799__auto__["getBasis"]).call(o__26799__auto__);
});
/**
...
}catch (e27776){var _e__26806__auto__ = e27776;
...
var G__27777 = (obj[cljs.core.first.call(null,path)]);
var G__27778 = cljs.core.rest.call(null,path);
obj = G__27777;
path = G__27778;
continue;
} else {
...
return (function (accum,p__27779){
var vec__27780 = p__27779;
var bit = cljs.core.nth.call(null,vec__27780,(0),null);
var protocol = cljs.core.nth.call(null,vec__27780,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27783){
var vec__27784 = p__27783;
var ns = cljs.core.nth.call(null,vec__27784,(0),null);
var name = cljs.core.nth.call(null,vec__27784,(1),null);
var selector = cljs.core.nth.call(null,vec__27784,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27789,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27789,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27789,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27787_SHARP_){
return (obj[cljs.core.first.call(null,p1__27787_SHARP_)]);
});})(name,sorted_matches,vec__27789,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
