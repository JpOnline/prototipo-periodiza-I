...
var o27686 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27686["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27687 = temp__5733__auto____$1;
return (o27687["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26796__auto__ = f;
return (o__26796__auto__["toString"]).call(o__26796__auto__);
} else {
return "";
}
}catch (e27688){var _ = e27688;
return "";
}});
...
try{var o__26796__auto___27690 = t;
(o__26796__auto___27690["cljs$lang$ctorPrWriter"]).call(o__26796__auto___27690,t,writer);
}catch (e27689){var __27691 = e27689;
}
...
var char_code = (function (){var o__26796__auto__ = (new String(char$));
return (o__26796__auto__["charCodeAt"]).call(o__26796__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26796__auto__ = String;
return (o__26796__auto__["fromCharCode"]).call(o__26796__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27692 = num_code;
switch (G__27692) {
case (1):
return (185);
...
var o__26796__auto__ = String;
return (o__26796__auto__["fromCharCode"]).call(o__26796__auto__,superscript_code);
});
/**
...
}catch (e27694){var _e__26803__auto__ = e27694;
return false;
}})())){
...
var vec__27695 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27695,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27698 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27698["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27699 = temp__5733__auto____$1;
return (o27699["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27702){
var vec__27703 = p__27702;
var ns_detector = cljs.core.nth.call(null,vec__27703,(0),null);
...
var G__27709 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27710 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27709;
remaining_tokens = G__27710;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27700){
var G__27701 = cljs.core.first.call(null,seq27700);
var seq27700__$1 = cljs.core.next.call(null,seq27700);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27701,seq27700__$1);
});
...
var vec__27714 = cljs.core.split_with.call(null,(function (p1__27713_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27713_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27714,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27714,(1),null);
...
var vec__27720 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27720,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27720,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27723 = cljs.core.rest.call(null,remaining_tokens);
var G__27724 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27723;
name_tokens = G__27724;
continue;
} else {
...
var vec__27727 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27727,(0),null);
var arity = cljs.core.nth.call(null,vec__27727,(1),null);
var vec__27730 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27730,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27730,(1),null);
var vec__27733 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27733,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27733,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27733,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27733,(3),null);
...
var vec__27739 = result;
var munged_ns = cljs.core.nth.call(null,vec__27739,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27739,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27739,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27739,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27739,(4),null);
var arity = cljs.core.nth.call(null,vec__27739,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27743 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__27743,(0),null);
var args = cljs.core.nth.call(null,vec__27743,(1),null);
var vec__27746 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27746,(0),null);
var name = cljs.core.nth.call(null,vec__27746,(1),null);
...
var G__27749 = (arity + (1));
var G__27750 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27751){
var vec__27752 = p__27751;
var arity = cljs.core.nth.call(null,vec__27752,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27752,(1),null);
...
return cljs.core.get.call(null,arities,p1__27755_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27756_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27759){
var vec__27760 = p__27759;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27760,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27757){
var G__27758 = cljs.core.first.call(null,seq27757);
var seq27757__$1 = cljs.core.next.call(null,seq27757);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27758,seq27757__$1);
});
...
var G__27766 = arg;
var G__27766__$1 = (((G__27766 instanceof cljs.core.Keyword))?G__27766.fqn:null);
switch (G__27766__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27768__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27768__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27768__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27768__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27769 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27769,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27769,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27769,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27769,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27769,(4),null);
var arity = cljs.core.nth.call(null,vec__27769,(5),null);
...
var o__26796__auto__ = f;
return (o__26796__auto__["getBasis"]).call(o__26796__auto__);
});
/**
...
}catch (e27773){var _e__26803__auto__ = e27773;
...
var G__27774 = (obj[cljs.core.first.call(null,path)]);
var G__27775 = cljs.core.rest.call(null,path);
obj = G__27774;
path = G__27775;
continue;
} else {
...
return (function (accum,p__27776){
var vec__27777 = p__27776;
var bit = cljs.core.nth.call(null,vec__27777,(0),null);
var protocol = cljs.core.nth.call(null,vec__27777,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27780){
var vec__27781 = p__27780;
var ns = cljs.core.nth.call(null,vec__27781,(0),null);
var name = cljs.core.nth.call(null,vec__27781,(1),null);
var selector = cljs.core.nth.call(null,vec__27781,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27786,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27786,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27786,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27784_SHARP_){
return (obj[cljs.core.first.call(null,p1__27784_SHARP_)]);
});})(name,sorted_matches,vec__27786,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
