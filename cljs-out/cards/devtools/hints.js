...
var column = cljs.core.get.call(null,map__28526__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e28525){var _e = e28525;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___28528 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___28528)){
var seen_errors_28529 = temp__5733__auto___28528;
if(cljs.core.truth_(seen_errors_28529.has(self))){
} else {
seen_errors_28529.add(self);

var temp__5735__auto___28530 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___28530)){
var sense_28531 = temp__5735__auto___28530;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28531)].join('');
} else {
}
}
} else {
